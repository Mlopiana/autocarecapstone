...
<nav class="navbar navbar-expand-lg sticky-top" style="background: linear-gradient(90deg, #2c2c2c, #1a1a1a); border-bottom: 4px solid #ffcc00;">
  ...
  <li class="nav-item">
    <a class="nav-link text-light fw-semibold" href="#" onclick="closeExpand()">
      <i class="bi bi-speedometer2 me-1"></i> Dashboard
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-light fw-semibold" href="#" onclick="expandView('appointments')">
      <i class="bi bi-calendar-check me-1"></i> Appointments
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-light fw-semibold" href="#" onclick="expandView('shops')">
      <i class="bi bi-geo-alt-fill me-1"></i> Shops
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-light fw-semibold" href="#" onclick="expandView('services')">
      <i class="bi bi-tools me-1"></i> Services
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link text-light fw-semibold" href="#" onclick="expandView('parts')">
      <i class="bi bi-nut-fill me-1"></i> Parts
    </a>
  </li>
</ul>
